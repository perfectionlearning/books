...
(lib.tree = function(mode,startPosition,loop) {
	...
	this.shape_28.graphics.f("#C79153").s().p("");
...
(lib.InstructionText = function(mode,startPosition,loop) {
	...
	// Layer 2
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.rf(["rgba(133,133,133,0.651)","rgba(204,204,204,0)"],[0,1],-1.2,2.1,0,-1.2,2.1,502.2).s().p("Eg45ADeQ3khcABiCQgBiCXkhcUAXlgBcAhUAAAUAhVAAAAXkABcQXkBcAACCQAACC3kBcUgXkABdghVAAAUghUAAAgXlgBdg");
	...
	// Layer 1
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("A92EQIAAmdQgBiCCCABMA3qAAAQCDgBgBCCIAAGdg");
...
(lib.Symbol2 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("Eg//ADZIAAmxMBdGAAAQBlAAgBBkIAADpQABBkhlAAgEA89ACdQAyhGgBhZQAAhgg2hJIDHAAIAAFIgEA0IACdIgZAAIhNAAQhkAAAAhkIAAiAQAAhkBkAAIBHAAIAlAAIBfAAQg4BJABBgQgBBZAyBGg");
...
(lib.Symbol3 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0F204B").s().p("AMMGJIAAsRMApIAAAQB9AAABB9IAAIXQgBB9h9AAgA43GJIAAsRMAkjAAAIAAMRgEg1YAGJQh5gCABh7IAAoXQgBh9B+AAIb8AAIAAMRg");
...
(lib.popup = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:27.2},14).wait(1));
...
(lib.mc_backFan = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1).to({regY:15.7,rotation:-40.5,y:15.9},0).wait(1));
...
(lib.Symbol8 = function(mode,startPosition,loop) {
	...
	// Layer 2
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("ASSEPIAAodIAgAAIAAIdgAyxEPIAAodIAgAAIAAIdg");
...
(lib.mc_Helicopter1 = function(mode,startPosition,loop) {
	...
	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f().s("#000000").ss(0.5,1,1).p("AofhQIgBgIAnygrIAAAAAiuhkQABAAAAAAAiuhkIAAAAAi7hkIABADQAGgCAGgBAgOgZIABAAQgBAAAAAAAg1gZIAAAAAHRhWQAdAAAUAUQAVAVAAAdQAAAbgVAUQgUAVgdAAQgdAAgVgVQgUgUAAgbQAAgdAUgVQATgSAYgCQAEAAADAAgAIWBfIgFACAIhBcQgFgBgFgCAGiBmIAAAA");
