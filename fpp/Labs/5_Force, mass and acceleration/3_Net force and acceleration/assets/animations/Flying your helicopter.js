...
(lib.Symbol4 = function() {
	...
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AADC1IgDAAIgCAAIk4AAQh9AAAAh9IAAhvQAAh9B9AAIE4AAIACAAIADAAIE4AAQB9AAAAB9IAABvQAAB9h9AAg");
	this.shape_1.setTransform(292.5,-7.4);

	this.addChild(this.shape_1,this.shape);
}).prototype = p = new cjs.Container();
p.nominalBounds = new cjs.Rectangle(-47.5,-25.5,384.1,36.3);


(lib.SandElements = function() {
	this.initialize();
...
(lib.Symbol2 = function() {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("Eg//ADZIAAmxMBjNAAAQBkAAAABkIAADpQAABkhkAAgEA9hACdQAyhFgBhaQAAhfg3hKICkAAIAAFIgEA0TACdQAxhFABhaQAAhfg4hKICEAAQg4BJABBgQgBBaAyBFgEArXACdQhkAAAAhkIAAiAQAAhkBkAAIBsAAQg4BJAABgQABBaAxBFg");
...
(lib.Symbol3 = function() {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("ATAENIAAoaIAfAAIAAIagAzeENIAAoaIAfAAIAAIag");
	this.shape.setTransform(-114.8,-2.4);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#0F204B").s().p("AQwGtIAAioIAAoaIAAiXMAsWAAAQB+AAgBB9IAAJfQABB9h+AAgA1uGtIAAioIAAoaIAAiXMAl/AAAIAACXIAAIaIAACogEg9GAGtQh9AAAAh9IAApfQAAh9B9AAMAm5AAAIAACXIAAIaIAACog");
	this.shape_1.setTransform(-97.3,-1.5);
...
(lib.Symbol1 = function() {
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#708A33").s().p("");
	this.shape.setTransform(-82.1,192.4);
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#017D3F").s().p("AAAAAIABAAIgBABg");
	this.shape_2.setTransform(-84.8,156.9);
	...
	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.lf(["#28CEF5","#94FBFD"],[0,1],295.5,-102,292.3,136.4).s().p("EgzbASWQjc3fDctOMBolAAAMAAAAkvMholgACg");
	...
	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f("#FFFFFF").s().p("");
	this.shape_28.setTransform(692.6,-179.2);

	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f("#9EE6F2").s().p("");
	this.shape_29.setTransform(698.2,-188.3);
	...
	this.addChild(this.shape_43,this.shape_42,this.shape_41,this.shape_40,this.shape_39,this.shape_38,this.shape_37,this.shape_36,this.shape_35,this.shape_34,this.shape_33,this.shape_32,this.shape_31,this.shape_30,this.shape_29,this.shape_28,this.shape_27,this.shape_26,this.shape_25,this.shape_24,this.instance_7,this.shape_23,this.shape_22,this.shape_21,this.shape_20,this.shape_19,this.shape_18,this.shape_17,this.shape_16,this.shape_15,this.shape_14,this.shape_13,this.shape_12,this.shape_11,this.shape_10,this.shape_9,this.instance_6,this.instance_5,this.instance_4,this.instance_3,this.shape_8,this.shape_7,this.shape_6,this.shape_5,this.shape_4,this.shape_3,this.shape_2,this.shape_1,this.shape,this.instance_2,this.instance_1,this.instance);
}).prototype = p = new cjs.Container();
...
(lib.Symbol8 = function() {
	...
	// Layer 3
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(-98.3,-1.7);

	// Layer 2
	this.instance = new lib.Symbol4();
	this.instance.setTransform(-65.9,8.1);
...
p.nominalBounds = new cjs.Rectangle(-524,-56.5,1052,113);
...
(lib.Symbol1_1 = function() {
	...
	this.shape_54 = new cjs.Shape();
	this.shape_54.graphics.f("#580000").s().p("Ag9AjIBphKIAEAHIgEAcIATADIgDABIgLAAQgxAAg6Aog");
	this.shape_54.setTransform(56.6,37.1);

	this.shape_55 = new cjs.Shape();
	this.shape_55.graphics.f("#BA0204").s().p("Ag2APIABAAQA4goAzgBIAAAHQgyACgyArg");
	this.shape_55.setTransform(56.1,39.6);
	...
	this.shape_62 = new cjs.Shape();
	this.shape_62.graphics.f("#093F87").s().p("AjHCaIAegJIBqgcQDDg6AEgYImOBgIgKgEIGehkIAih9IAIgCIgYBcIAEAAQAfgHATgNQAIgGAFgGIAPhMIAfgIQgKBCgeAtQg7AMgTA5QgJAPgUAGIk/BmIgGgZgADLixIADgBIgHAgIgEABg");
	this.shape_62.setTransform(27.4,21.2);

	this.shape_63 = new cjs.Shape();
	this.shape_63.graphics.f("#0A4386").s().p("AgsAGIAHgBIgCALIgIACgAARgIIAfgJIgCAMIgfAGg");
	this.shape_63.setTransform(50.4,7.7);

	this.shape_64 = new cjs.Shape();
	this.shape_64.graphics.f("#BA0300").s().p("AgrAGIAHgCIgEARIgIACgAASgJIAfgIIgBANIgBADIggAGgAgkgUIAHgCIgFARIgHACg");
	this.shape_64.setTransform(50,8.9);

	this.shape_65 = new cjs.Shape();
	this.shape_65.graphics.f("#E74994").s().p("AgaAMIAzgMIgDAOIg0APgAgTgOIAygOIgEARIgyAMg");
	this.shape_65.setTransform(49.3,8);
	...
	this.addChild(this.shape_68,this.shape_67,this.shape_66,this.shape_65,this.shape_64,this.shape_63,this.shape_62,this.shape_61,this.shape_60,this.shape_59,this.shape_58,this.shape_57,this.shape_56,this.shape_55,this.shape_54,this.shape_53,this.shape_52,this.shape_51,this.shape_50,this.shape_49,this.shape_48,this.shape_47,this.shape_46,this.shape_45,this.shape_44,this.instance_8);
}).prototype = p = new cjs.Container();
