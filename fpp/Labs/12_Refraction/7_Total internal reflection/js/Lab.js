...
var Lab = (function () {
	...
	Activity.prototype.reset = function () {
		...
		this.layout["cross_s"].visible = false;
	...
	function createPlayers() {
		...
		var a = new VectorLine(this.layout.arrow1, {x: 914,y: 450}, {min: 100,max: 100}, {min: 0,max: 360}, this.layout.arrow1Line, {color: "#0000ff",lineWidth: 2,	direction: "left"
			},Model.snapValue);
		var e = {
			stageX: 664,
			stageY: 200
	...
	function displayCross() {	
		...
		if(scope.activePlayer.auto){
			...
			var cross = scope.layout["cross_s"];
