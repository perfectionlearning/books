	...
	function enterFrame(){
		...
		this._points.forEach(function(v, i){
			...
			if(v.bird){
				...
				if(waveLength && v.bird._thresholdF && (v.y.toFixed(2) * 1 >= (this._A - 0.01) && this._A != 0) && (waveLength.toFixed(1)== 1 || waveLength.toFixed(2)==0.50 || waveLength.toFixed(2)==0.33 || waveLength.toFixed(2)==0.25 || waveLength.toFixed(2)==0.20||waveLength.toFixed(3)==0.167))
				{
					v.bird.flag1 = true;
