...
lib.properties = {
	...
	color: "#FFFFFF",
	manifest: [
		{src:"images/Grass.png?1492183674108", id:"Grass"}
	]
};
...
(lib.wing = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f("#663300").s().p("AgwAKQAIgOAIABQgYAcBlgfQg9AbgVAAQgNAAACgLgAgagFQAHgNAGABQgTAXBRgaQgxAWgRAAQgKAAABgHg");
	this.shape.setTransform(-18.8,20.8);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#401205").s().p("AgngUIABgCIANABIABAAIAMAAQAIgBAEgCIACgDQADgDAEAAQAGgCAHAFQACADAQgCIAGgBIABAAIACAAQASgDAFADIABABQACACgBAEIgDACIgLAJQggAWgtANIgPAEIgUACQgwAAA9g0gAg7AKQgGAcBjgsQhlAeAYgbIgCAAQgHAAgHANgAglgFQgFAWBQglQhRAZATgXIgBAAQgGAAgGANg");
	this.shape_1.setTransform(-17.7,20.9);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#5A96DC").s().p("AAhAwQARgkAdgNQARgEgLAPQgpAogJAAQAAAAAAAAQgBAAAAAAQgBgBAAAAQAAgBAAAAgAhYApQABgiAtg0QANgIADAHQADAIgHAVQgqBCgMAAQgEAAAAgIg");
	this.shape_2.setTransform(-14.1,11.8);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#003F65").s().p("AANA0IBQhHIAKgJIAAAKIhZBMQABgFgCgBgAhVA5IBPhjIABgCIAFAAIAAAFIAAAAIhIBgIgMAAIgBAAgAhmA1IBLhrIABgCIAKAAIAAAEIgBADIhRBpgAALgtIAAAOIg8BPQgEAAgDADIgDACgAAqgfIAAAMIAAABIgzBFIgCAAIgBAAIgGAAg");
	this.shape_3.setTransform(-11.7,12.9);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#2276D6").s().p("");
	this.shape_4.setTransform(0.5,-2.1);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#238FF2").s().p("");
	this.shape_5.setTransform(2.7,-4.4);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#3DE6F9").s().p("");
	this.shape_6.setTransform(9.6,-4.7);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#59A8ED").s().p("");
	this.shape_7.setTransform(4.3,-6.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-25.1,-24,50.3,48.2);
...
(lib.RedParrot = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_38},{t:this.shape_37},{t:this.shape_36},{t:this.shape_35},{t:this.shape_34},{t:this.shape_33},{t:this.instance_8}]}).to({state:[]},4).to({state:[{t:this.shape_37},{t:this.shape_38},{t:this.shape_36},{t:this.shape_35},{t:this.shape_34},{t:this.shape_33},{t:this.instance_8}]},5).to({state:[]},18).to({state:[{t:this.shape_43},{t:this.shape_42},{t:this.shape_34},{t:this.shape_36},{t:this.shape_35},{t:this.shape_33},{t:this.shape_41},{t:this.shape_40},{t:this.shape_39}]},71).to({state:[]},27).to({state:[{t:this.shape_43},{t:this.shape_42},{t:this.shape_36},{t:this.shape_34},{t:this.shape_35},{t:this.shape_33},{t:this.shape_41},{t:this.shape_40},{t:this.shape_39}]},55).to({state:[]},48).to({state:[]},60).wait(57));
...
(lib.kingfisherc = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(48.5,28.4,1,1,0,0,0,18.8,-21.2);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regY:-21.1,rotation:30},7).to({regY:-21.2,rotation:0},8).to({regY:-21.1,rotation:30},8).to({regY:-21.2,rotation:0},8).wait(1));

	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#553327").s().p("AAEgUQAEgBADAAQAAAAABABQABAAAAAAQAAABAAABQAAAAAAABIgHAIQgKAFgFAaQgKgZAXgRg");
	this.shape.setTransform(30.9,83.7);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#E86610").s().p("AhNAfQAQgSAtgPIgUgZIAFgHIAWAdQAIACALABQAugBAWATIgBAAQgfgPgcAFIgTACIgNgBIgFABQghAJgXASQAAgBAAgBQAAgBAAAAQAAgBgBAAQgBAAAAAAg");
	this.shape_1.setTransform(39.9,78.4);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#DF281A").s().p("AhIAfQAYgSAhgJIAEgBIAMABIAVgCQAcgDAfANIhDgCIgFACIAAAAQgJADgOgBQggAAghAZIAHgIgAgfgDQAKgCgQgUIAFgGIAUAZQgtAPgRASQgCgBgFACIgGABQAVgSAjgOgABSAMQgXgTgtABQgNgBgGgCIgWgdQAIAGASARQAfgDAdANQAfALgDAIIgFgCg");
	this.shape_2.setTransform(39.5,78.8);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#92EFFE").s().p("AgSg1QAPAMAKgFQAPgHgBAZIAAAjQAAATgFgPQgFgNABgfQAAgEgFACQgEACgCAEQgBBHgIALIgCABQgQAAAIhrg");
	this.shape_3.setTransform(6.5,79.7);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#2276D6").s().p("AhSBoQgyAnAmhIQAOAfAPhDQgBAlAGgFQAHgEAIgoIAHg0QADAxANgXQANgZAAhLIB4gbIAAAAQgbAGgSAdQgTAegPAEQgGANgJAnQgIAigKATQgwBXgUAAQgLAAgCgbg");
	this.shape_4.setTransform(11.2,83.6);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#4BD2F2").s().p("");
	this.shape_5.setTransform(17.1,58);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#F08415").s().p("AilDnQAAguA5glQAhgWA2gTQBYhBBCh/QALgNAEgTQAEgTgDgYIgCgIQgIgggNgTIgFgGIgBgDQgFgHAFAAQAFAAAJAKQAVAVAHAfIACAIQACAMAAANIgDAaQgJA8gPAVQgqBPgqAqQgPAOgOAJIgqAsQhjBRgkAAQgJAAgFgFg");
	this.shape_6.setTransform(43,49.5);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#DD5700").s().p("");
	this.shape_7.setTransform(35.7,55.2);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#EAD7C8").s().p("AhDg3QAGABAHAFQgDAMgMAQQAPgMARgFQgBAMgLALQgOAVggAUQgJAIgCgIQgOgEgmAiIgDAAIgVADQAUhMBfgmgAA4AgQgDgGgGABQgSAHgHgFQgZgMB+hKIAAAAQAfAAAdgBQhlAxAUAnQgLgBgEgGQgIAGgGAEIgCABQgFACgDAAQgEAAgDgEg");
	this.shape_8.setTransform(44.8,19.9);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#0072CA").s().p("");
	this.shape_9.setTransform(45.1,17.6);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#FFFFFF").s().p("AgBACIgBgCIABgBIABgBIACABIABABIgBACIgCABIgBgBg");
	this.shape_10.setTransform(46.4,7.5);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#E0D0C0").s().p("AAAAFIgBABIgFgCQgDgCAAgCQAAgBADgCQADgCADAAQAEAAADACQADACAAABQAAACgDACIgFACIgCgBg");
	this.shape_11.setTransform(47.8,6.7);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#894D05").s().p("");
	this.shape_12.setTransform(47.9,8.2);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#000000").s().p("AAAAgQgIAAgHgEIgGgGQgKgJAAgNQAAgMAKgKQAJgJAMAAQANAAAJAJQAKAKAAAMQAAANgKAJQgDAEgFADQgGADgHAAIgBAAgAgQgRQgHAJgBAIQABAKAHAIQAIAIAIAAQALAAAHgIQAIgIAAgKQAAgIgIgJQgHgHgLAAQgIAAgIAHgAgGAGQgCgDgBgDQABgCACgDIAFgCIABAAIABAAIAEACQACADAAACQAAADgCADQgDADgCAAQgDAAgDgDg");
	this.shape_13.setTransform(47.8,8.2);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#F9B200").s().p("AgYANQgSAFgPAMQAMgQADgMQgGgDgHgBQgNgEgMAIIAJgLQgOgDgJADQAkgbBUACQAHAEAJAAIACAAQAGAAAGgDQAQABASADIAEAAIgEACQgcABgSAFQgeAIgIAPQgNAdgeAFQALgLACgMg");
	this.shape_14.setTransform(43.6,14.6);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#61E2F8").s().p("");
	this.shape_15.setTransform(43,4);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#5D81A5").s().p("");
	this.shape_16.setTransform(40.6,11.8);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#EB8E4B").s().p("AhpABQAYgKAGgLQCSADBUARQjWAEhfARQAegLATgJg");
	this.shape_17.setTransform(71.5,8.6);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#D12300").s().p("AiZAWIgPgQQBPgYECgEQhrAiiDAIIgYABQgdACgegBg");
	this.shape_18.setTransform(72.5,11.8);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#D2B7A4").s().p("AgsAtIgFAAQgUgpBjgvIAXgBIhEAuQgcAVgBAWg");
	this.shape_19.setTransform(60.1,18.4);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#BE280D").s().p("AglgPQAPgKAQAQQAIgFgCgPQANgBgEAYIARgNQADAFgHALIAQgHQAAAIgKAIQgTAKgcAKIgOAEQAdgnghgGg");
	this.shape_20.setTransform(58,8.1);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#255C92").s().p("");
	this.shape_21.setTransform(34.2,37.8);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#7E2016").s().p("AihAQIgagEIAFgCIAAAAIAPgDIANgFQBggODWgGIAfAHIgHACQkCAEhPAYg");
	this.shape_22.setTransform(71.4,10.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(32));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,90.2,96.8);
...
(lib.Wavelength = function(mode,startPosition,loop) {
	...
	this.instance_5 = new lib.kingfishera();
	this.instance_5.setTransform(487.6,249.6,0.32,0.32,0,0,0,45.1,48.3);

	this.instance_6 = new lib.kingfisherc();
	this.instance_6.setTransform(869.6,249.6,0.32,0.32,0,0,0,45.1,48.3);

	this.instance_7 = new lib.kingfisherb();
	this.instance_7.setTransform(658.1,249.6,0.32,0.32,0,0,0,45.1,48.3);
