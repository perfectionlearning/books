...
lib.properties = {
	...
	color: "#FFFFFF",
	manifest: [
		{src:"images/Grass.png?1492186848122", id:"Grass"}
	]
};
...
(lib.Symbol4 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AACC1IgCAAIiaAAQh8AAAAh9IAAhvQAAh9B8AAIE1AAQB8AAABB9IAABvQgBB9h8AAg");
	this.shape.setTransform(322.8,0.7);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("AACC1IgCAAIiZAAQh+AAABh9IAAhvQgBh9B+AAIEzAAQB9AAABB9IAABvQgBB9h9AAg");
...
(lib.Symbol3copy = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#0F204B").s().p("ARaGTIAAslMAp7AAAQB9AAAAB9IAAIrQAAB9h9AAgA4MGTIAAslMApRAAAIAAMlgEgnNAGTIAAslIOvAAIAAMlgEg7YAGTQh5gDAAh6IAAorQAAh9B9AAIT1AAIAAMlg");
	this.shape.setTransform(-96,1);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("EhQHAEPIAAodMB+yAAAQB1AEAAB5IAAEjQAAB5h1AEgEBMPADFQA+hYAAhwQAAh3hFhcIEAAAIAAGbgEBAtADFQA+hYAAhwQAAh3hFhcIClAAQhGBcAAB3QAABwA+BYgEA1iADFQgPAAgNgCQgdgFgVgMQgLgHgJgKQgbggAAg6IAAigQAAg6AbgfQAJgKALgHQAVgNAdgEQANgCAPAAICHAAQhFBcAAB3QAABwA+BYg");
...
(lib.Symbol1 = function(mode,startPosition,loop) {
	...
	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#000000").s().p("");
	this.shape_9.setTransform(-18.3,14.3);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#000000").s().p("");
	this.shape_10.setTransform(-17.8,20.3);
	...
	this.shape_12.graphics.f("#000000").s().p("");
	this.shape_12.setTransform(22.9,9.8);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#000000").s().p("");
	this.shape_13.setTransform(22,17.9);
...
(lib.mouth = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#130400").s().p("AgfAgQgNgOAAgSQAAgSANgNQANgNASAAIACAAQgEAGAAAIQAAAKAFAHQAHAGAJAAQAKAAAHgGQADgDABgDQAFAJAAAKQAAASgNAOQgOANgSAAQgSAAgNgNg");
	this.shape.setTransform(-50.7,-68);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#311C00").s().p("Ag4A4QgXgXAAghQAAggAXgYQAYgXAgAAQAhAAAXAXQAYAYAAAgQAAAhgYAXQgXAYghAAQggAAgYgYgAgfgfQgNANAAASQAAASANAOQANANASAAQASAAAOgNQANgOAAgSQAAgKgFgKQACgEAAgGQAAgJgGgHQgHgHgKAAQgJAAgHAHIgBABIgCAAQgSAAgNAOg");
	this.shape_1.setTransform(-50.7,-68);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AgOAQQgIgHABgJQgBgHAGgGIACgBQAGgIAIABQAJgBAHAIQAGAGABAIQAAAFgCAFQgCADgDADQgHAGgJAAQgIAAgGgGg");
	this.shape_2.setTransform(-48.7,-71.1);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#070901").s().p("AhIBJQgfgeAAgrQAAgqAfgeQAegfAqAAQArAAAeAfQAfAeAAAqQAAArgfAeQgeAfgrAAQgqAAgegfgAg4g4QgXAYAAAgQAAAhAXAXQAYAYAgAAQAhAAAXgYQAYgXAAghQAAgggYgYQgXgXghAAQggAAgYAXg");
	this.shape_3.setTransform(-50.7,-68);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#6B8900").s().p("AimFZIgBAAIgBAAIgCgIIAAgGIAAAAIAAgCIAAgCQABgOAHgHQAKgLAHgFQAHgFALgLIAAgBQAtgxANgeQASgoAEgRIAIgmIACgMIABgEIADgwQADg5AAgVIABhLQAAg1AKgnQAJgoATgcIAMgMQANgOAxgjIAkgLQhFA7gKBdQgPCJgIDjIABAwQABAmA3AUQATAHBOAYIgsAIIhTAQIhWAOQghAGghADIgPABQgWAAgVgGg");
	this.shape_4.setTransform(-28.3,-62.6);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FF0000").s().p("Akgh/QAEgHAEgGQAfgoAAgRQAAgLgEgNQE7BMDBEOIAHATIgGgRIAbAnQAEAaACAeQi2kHmLhWgAALBzQg2gDgNgDQgvgMgwgIQgxguhHgZQAfgHAsAAQCIAgBjA3QgEARgVAAIgDAAgAjbgZQg4gggCgDIAAgBIAeAGQAoAJAnAKQAkALAkAPIBLAfQAaANAaAPQAGAQACAMQhmhGicggg");
	this.shape_5.setTransform(123.4,-29.1);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FF5151").s().p("AjygrIgFgRQgJgYgDgNIgBgJQgFgcACgXQACgVAHgQQAUgrgFhBQFuDMCKGRQjBkPk6hLg");
	this.shape_6.setTransform(122.3,-46.9);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#880015").s().p("");
	this.shape_7.setTransform(123.1,-42.2);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#BADB00").s().p("Ah3AXQhSgehQgaQE8g5DzA7QAEAOAAALQAAAPgfAoQgEAGgEAHQikgjjGgEg");
	this.shape_8.setTransform(70.1,-48.2);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#C59C0B").s().p("ACKAdQglgEglgBQgpgBgoAAIgYABQhGgehGgcQDHAECkAhQgHAQADAQIgogGg");
	this.shape_9.setTransform(76.2,-42.3);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#00E6EF").s().p("AAIA4IARgJQAagPgFgUQgEgNhJgCQgYgBiUADQh8ABhGgFQghgCgggEQIjg9FOBMQgsAAgfAHQBHAZAwAuQjpgsjeASgADQg6QgPgKgYgMIAyAAQAkABAlAEIAtAHIAAAAIAAABQADAEA3AfQhVgShmgIg");
	this.shape_10.setTransform(61.7,-28.4);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#678F13").s().p("AloCIIgCgBIgEgDIgUgPIgXgSIgdgmIgJgPIgHgMIgLgSIgagqIgEgHQgHgNgHgIIgHgIQANAAANgBQAhgCAhgGIBYgPIBTgPIBRgPIBLgMIApgHQAoAJAoAHIgWACIifAUQhIAIgzAJQgzAJARAyQASAwBeAaQBfAZGThbQBtgZBwgJQgRAHgbAJQgwAPgNAHQgbALAEAPQADALAaAHQAJADAQACIiQARImQA2IgSACQixAXg+AAIgCAAg");
	this.shape_11.setTransform(10.8,-17.9);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#111110").s().p("");
	this.shape_12.setTransform(51,-47.2);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#00BDC1").s().p("Ag5BsQgagHgDgKQgEgQAbgNQAOgHAwgPQAYgJARgHQDegSDqAsQAVAUAQAXQhwgWhvAJQi5APidASQgPgCgKgDgAoUg+IAogGIBTgNQApgGAqgFQApgFAogDQAtgEAsgBIBJgDIBLgBIBXgCIBZAAIAigBQAXAMAQAKQjzgRlPAwIAAgCIgkAFIgBAAIg+AIIgPACQgpgGgogKg");
	this.shape_13.setTransform(58.4,-25.2);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#CAE147").s().p("Ah7DmQhNgZhMgTQhggXhEgMQAQgXAKgiQAUhNgThbQgThdAegoQAMgOgNgKQIBAXFKC3QAFA+gUArQgHARgCAUQgCAXAFAdIABAJQADANAJAXIAFASQj0g8k8A6g");
	this.shape_14.setTransform(54.2,-74.6);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#EB503A").s().p("AlbB2QgqgUgXgXQgVgUgGgWQgMgsAigzQALgSAPgNQAdgaAqgLQAngKBqATQBEAMBhAXQBKATBNAZQBQAZBSAeQBGAcBGAhIhCABIhYABIhMABIhIADQgtACgsADQgpADgmAFIhTALIhTANIgPACIhDALIgfAFQgUgHgVgKg");
	this.shape_15.setTransform(27.7,-47.2);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#FFFFFF").s().p("AH7FsQhkg3iJggQlMhOokA9IgdADIAXgEIA+gKIAkgFQFQgwDyARQBmAIBVASQCdAiBnBGQA5AmApAyQgsglg2gegALTGHQiKmRlwjMQlHi3oEgWIhngDIBSgFQIKgZFMCyQF+DLCIHQIAFARIgHgTg");
	this.shape_16.setTransform(76.5,-55.7);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#D3E385").s().p("AiaB8QgghdAxh2QAvh5CNgDQA8gBAdAGIhSAFIBnADQANAJgMAPQgeAoAUBdQATBbgVBMQgJAjgRAWQhrgSgkAKQgqAKgdAbQgqgXgWhBg");
	this.shape_17.setTransform(-2.4,-77.9);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#96BA00").s().p("");
	this.shape_18.setTransform(35.3,-57.3);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#FF0000").s().p("AndgdQguiRAIiQQAGBjAgBkQCBGSHUg+QEqgoBhjSQAEAqgDAsQhhDWkrAoQg/AIg4AAQlvAAhvlcg");
	this.shape_19.setTransform(-71.7,70.4);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#F3DC1C").s().p("ApZIyQgfhkgGhjQAOkCBuiuQBtiwAKgZQAIgYBAiBQBAiBBZiIQBYiJDDg+QB9goDJAaQAbAVAZAZQCUCUAADSQAACThJB1QgfAyhhBxQhhBwgJD4QAVCBAiDJIAFAgQhhDUkoAoQg/AIg4AAQlxAAhwleg");
	this.shape_20.setTransform(-59.4,2.1);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#020202").s().p("AhXgtQCqmTCVjTQhBCNhKDJQimHLAlGHIgEACIh7BFIhCA3IgBABQgMlXCblqg");
	this.shape_21.setTransform(-129,1.4);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#292929").s().p("AomKNQgahQgJhPQgoAKglAPIgUAIQglmHConMQBKjJBBiNQBZh+BRg5QCHhgCDgkQATgBAKgGQBBgOBBAAQCuAACEBmQAbAVAZAZQCUCUAADSQAACThJB1QgfAyhhBxQhhBwgJD4QAVCBAjDJIAEAgIAAABIACAbIAAACIAAACIAAAZIgBAbIAAAEQhhDWkrAoQg8AIg5AAQlwAAhwleg");
	this.shape_22.setTransform(-64.4,2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-152.2,-102.4,304.6,204.9);
...
(lib.lag = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#009DC0").s().p("AA/gsQgWgcgggZQgJgLgWAGQAhgMAXAIIAWAIQASAGAVAgQAUAfgGA/QgGBAgxAMQAdh/gUgbgAhMBnQAuh8geggQgagbgXgPQAegSAVAHIAXAHIADABIgBACQAfAYAUAcQAUAbgWBKQgLAdgTAKQgSAJgWAAQgLAAgLgCg");
	this.shape.setTransform(41.5,-0.8);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#006C84").s().p("AAhBeQAVgKAMgdQAWhKgVgbQgWgcgfgZIACgCIAKgDQAVgHAMALQAfAZAWAdQAVAbgeB/IgKAAQghAAgbgOgAhNA2QADgngMgQQgMgSgRAKIgFgJIAEggQABgIADgHQAMgZAogHQAXAPAaAbQAcAfgsB8Qg0gGACgog");
	this.shape_1.setTransform(36.5,-0.5);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#006C84").s().p("AAhBeQAVgLAMgcQAWhKgVgbQgWgcgfgZIACgCIAKgDQAVgHAMALQAfAZAWAdQAVAbgeB/IgKAAQghAAgbgOgAhNA2QADgngMgQQgMgTgRALIgFgJIAEggQABgIADgHQAMgZAogHQAXAPAaAbQAcAfgsB8Qg0gHACgng");
	this.shape_2.setTransform(-40.4,-0.5);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#009DC0").s().p("AA/gsQgWgcgggZQgJgLgWAGQAhgMAXAIIAVAIQATAGAVAgQAUAfgGA/QgGBAgxAMQAdh/gUgbgAhMBnQAuh8geggQgagbgXgPQAegSAVAHIAXAHIADABIgBACQAfAYAUAcQAUAbgWBKQgMAdgTAKQgRAIgWAAQgLAAgLgBg");
	this.shape_3.setTransform(-35.5,-0.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-52.5,-11.8,105.2,22.2);
...
(lib.RedParrot = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(182).to({_off:false},0).wait(9));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape}]},59).to({state:[{t:this.shape_1}]},3).to({state:[{t:this.shape}]},3).to({state:[{t:this.shape_2}]},3).to({state:[{t:this.shape}]},3).to({state:[{t:this.shape_2}]},3).to({state:[{t:this.shape}]},3).to({state:[]},13).to({state:[{t:this.shape}]},32).to({state:[{t:this.shape_1}]},3).to({state:[{t:this.shape}]},3).to({state:[{t:this.shape_2}]},3).to({state:[{t:this.shape}]},3).to({state:[{t:this.shape_2}]},3).to({state:[{t:this.shape}]},3).to({state:[]},7).to({state:[]},36).wait(8));
	this.timeline.addTween(cjs.Tween.get(this.shape).wait(59).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},13).wait(32).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},3).wait(3).to({_off:false},0).to({_off:true},7).wait(44));
	...
	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#000000").s().p("AhCAgQgPgRgDgFQgFgaAcgeIAEAEQASAOAzABIA4AAQAAADACADIAQAOQgKAHgCAEQgCAGgBAQQgWASgxADIgMAAQgpAAgNgPg");
	this.shape_8.setTransform(3.6,-72.7);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_23},{t:this.shape_22},{t:this.shape_21}]}).to({state:[]},4).to({state:[{t:this.shape_21},{t:this.shape_22},{t:this.shape_23}]},5).to({state:[]},173).wait(9));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_32},{t:this.shape_31},{t:this.shape_30},{t:this.shape_29},{t:this.shape_28},{t:this.shape_27},{t:this.instance_2},{t:this.shape_26},{t:this.shape_25},{t:this.shape_24}]},4).to({state:[]},5).wait(182));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(4).to({_off:false},0).to({_off:true},5).wait(4).to({_off:false},0).to({_off:true},5).wait(4).to({_off:false},0).to({_off:true},5).wait(164));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(4).to({_off:false},0).to({_off:true},5).wait(4).to({_off:false},0).to({_off:true},5).wait(4).to({_off:false},0).to({_off:true},5).wait(164));

	// L Wing
	this.instance_5 = new lib.Tween13("synched",0);
	this.instance_5.setTransform(16.7,-57.6,1,1,0,0,180,2.5,-33.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({_off:true},4).wait(23).to({_off:false},0).wait(164));

	// R Wing
	this.instance_6 = new lib.Tween13("synched",0);
	this.instance_6.setTransform(-16.4,-57.6,1,1,0,0,0,2.5,-33.9);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({_off:true},4).wait(23).to({_off:false},0).wait(164));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(59).to({_off:false},0).wait(4).to({regX:-5.8,rotation:-16.2},0).wait(4).to({regX:-5.7,rotation:-3},0).wait(4).to({regX:-5.8,rotation:-16.2},0).wait(4).to({regX:-5.7,rotation:-3},0).to({_off:true},15).wait(32).to({_off:false},0).wait(4).to({regX:-5.8,rotation:-16.2},0).wait(4).to({regX:-5.7,rotation:-3},0).wait(4).to({regX:-5.8,rotation:-16.2},0).wait(4).to({regX:-5.7,rotation:-3},0).to({_off:true},9).wait(44));
	...
	this.shape_34.graphics.f("#969696").s().p("AhsgDQARgfAFgFIAEgGQgLAXALAMQgbAcAFAcQgTgaAPgXgABQAGIgHgCQgDgEgBgEQgBgFACgFQAEgFAGgBQAGgCABAKQABAFANAGIAOAEQgWADgKAAIgDAAg");
	this.shape_34.setTransform(5.6,-76.3);

	this.shape_35 = new cjs.Shape();
	this.shape_35.graphics.f("#333132").s().p("AgRAmQgFgBgEgDIgQgOQgCgDAAgDQgBgFABgFQADgRAKgIQAIgIATgKIAAAHQgBARAYAEIAFACQAMAFAKATQgJAHgSAKQgOAIgKAAQgGAAgGgCgAgLgOQgHABgEAFQgCAFABAEQABAFAEAEIAHADQAKAAAXgEIgPgFQgLgEAAgGQgBgIgFAAIgBAAg");
	this.shape_35.setTransform(15,-77);

	this.shape_36 = new cjs.Shape();
	this.shape_36.graphics.f("#000000").s().p("AhCAgQgPgRgDgFQgFgaAcgeIAEAEQASAOAzABIA4AAQAAADACADIAQAOQgKAHgCAEQgCAGgBAQQgWASgxADIgMAAQgpAAgNgPg");
	this.shape_36.setTransform(3.6,-72.7);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_38},{t:this.shape_37},{t:this.shape_36},{t:this.shape_35},{t:this.shape_34},{t:this.shape_33},{t:this.instance_8}]}).to({state:[]},4).to({state:[{t:this.shape_37},{t:this.shape_38},{t:this.shape_36},{t:this.shape_35},{t:this.shape_34},{t:this.shape_33},{t:this.instance_8}]},5).to({state:[]},18).to({state:[{t:this.shape_43},{t:this.shape_42},{t:this.shape_36},{t:this.shape_35},{t:this.shape_34},{t:this.shape_33},{t:this.shape_41},{t:this.shape_40},{t:this.shape_39}]},32).to({state:[]},31).to({state:[{t:this.shape_43},{t:this.shape_42},{t:this.shape_35},{t:this.shape_34},{t:this.shape_36},{t:this.shape_33},{t:this.shape_41},{t:this.shape_40},{t:this.shape_39}]},32).to({state:[]},25).to({state:[]},35).wait(9));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_51},{t:this.shape_50},{t:this.shape_49},{t:this.shape_48},{t:this.shape_47},{t:this.shape_46},{t:this.shape_45},{t:this.shape_44}]}).wait(191));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_11},{t:this.instance_10}]},9).to({state:[]},4).to({state:[{t:this.instance_11},{t:this.instance_10}]},5).to({state:[]},4).wait(169));
...
(lib.Dragonbird = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 2
	this.instance = new lib.mouth();
	this.instance.setTransform(86.6,-229.4);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(8).to({skewY:180,x:-83.1},0).wait(7).to({skewY:0,x:86.6},0).wait(1));

	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#4D4D4D").s().p("AhOCEQhSC4hyCLQhniRAaiyQhTBQgTCRQihi4A/jSQh7BjApCgQhdiNBBjAQgviXgvDtQhIikARhzQASh0BqhCQgvBpASBKQBvh4CjgTQhgDtB4BqQATiYCZgwQgHCvB5BfQBYgwAfilQCqCVAgCgQBqg9A+j5QB2BtBdCYQCBiThHiqQENB9h3F1IgGABQgliXgcAhQAAB7iZCDQgLivhTAMQgGDAiNA5QArh8iVg8QgICOhuBvQgUkCiShhg");
	this.shape.setTransform(-8.8,-74.7);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#292929").s().p("AKaJ1IAGgBIgFAHIgBgGgAhZgVQgeCDiGA7QhFhlBFh+Qi7AtgyCVQg0iXBhiZQjZAAgwBOQgKhgBshgQhrgVhgAkQAvhVBXhVQBYhUCGg0QCmhADnADQGgAGD7DRQCWB8A9CaQhDgZhSAPQBnCEAYCPQh9iGjqgbQA0Clg0CoQhjjQieg+QgrCZg7CiQgYi+iNisg");
	this.shape_1.setTransform(1.8,-118);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#373737").s().p("");
	this.shape_2.setTransform(-3.7,-53.2);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#020202").s().p("AsJLHQk9p8BEmSQBFmUEHjsQBLhEBRgSQJsj0J5EbQAXAQAWATQEXDmAAGaQAAGXk0GFQkzGGm5D5Qh9BHhzAAQklAAjjnIg");
	this.shape_3.setTransform(-6.9,-71.2);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#292929").s().p("");
	this.shape_4.setTransform(-24.7,95.7);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#191919").s().p("");
	this.shape_5.setTransform(-24.1,102.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(16));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-110.8,-331.9,349.7,546.5);
...
(lib.Button_Set_1 = function(mode,startPosition,loop) {
	...
	// Layer 3
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AcIEPIAAodIAVAAIAAIdgAtdEPIAAodIASAAIAAIdgA8cEPIAAodIASAAIAAIdg");
...
(lib.Wavespeed = function(mode,startPosition,loop) {
	...
	this.instance_3 = new lib.lag();
	this.instance_3.setTransform(785.1,267,0.24,0.24);

	this.instance_4 = new lib.RedParrot();
	this.instance_4.setTransform(201.8,266.3,0.8,0.8);

	this.instance_5 = new lib.Dragonbird();
	this.instance_5.setTransform(786.4,267.7,0.24,0.24);

	this.instance_6 = new lib.Elewire();
	this.instance_6.setTransform(579.9,271.3);

	this.instance_7 = new lib.Button_Set_1();
	this.instance_7.setTransform(512.1,758.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}]}).to({state:[{t:this.instance_2},{t:this.instance_1}]},1).to({state:[{t:this.instance_5},{t:this.instance_4},{t:this.instance_3}]},1).to({state:[{t:this.instance_6}]},1).to({state:[{t:this.instance_7}]},1).wait(1));
