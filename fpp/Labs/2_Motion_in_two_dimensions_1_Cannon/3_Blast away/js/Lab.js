var Lab = (function(){
	...
	Activity.prototype.reset = function(){
		var targetValue1 = /* 0// */ Model.randomNumber(0, 6) * 15;
		var targetValue2 = /* 90// */ Model.randomNumber(0, 6) * 15;
	...
	function nextTurn(){
		...
		if(this.activePlayer){
			...
			if(this.activePlayer.data("point0") && this.activePlayer.data("point1")){
				var text;
				if(this.gameMode == "PVC"){
					text = this.playerIndex == 0 ? "You win!" : "Computer win!"
				} else {
					text = this.playerIndex == 0 ? "Player 1 wins!" : "Player 2 wins!"
				}
				...
				// Player 1 wins!
				// Player 2 wins!
				this.stage.addChild(this.layout.playAgainScreen);
...
Lab.data = {
	player1:{
		...
		startX:sV(191),
		boundary:[
			[{x:sV(90 * 1.34) ,y:sV(434 * 1.34 + 15)}, {x:sV(665 * 1.34),y:sV(434 * 1.34 + 15)}], 
	...
	player2:{
		...
		boundary:[
			...
			[{x:sV(92 * 1.34) ,y:sV(371 * 1.34 + 15)}, {x:sV(92 * 1.34), y:sV(175 * 1.34 + 15)}]
		]
	}
}
