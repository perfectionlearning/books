...
CAAT.Foundation.Actor.extend(
	{
		...
		userDrag: function (callback, callback1) {
			...
			this.mouseDrag = function (mouseEvent) {
				...
				if(callback){
					this.snap = callback(this, mouseEvent, pt.x - this.__d_ax, pt.y - this.__d_ay);
...
game = {
	...
	StartGame : function(){
		...
		var assets = [{id:'gray50', url:game.sharedPath + 'gry50.gif'},
					...
					{id:'digram', url:game.actPath + 'digram.gif'},
					{id:'battery', url:game.actPath + 'battery.gif'},
					{id:'130pixwire', url:game.actPath + '130pixwire.gif'},
