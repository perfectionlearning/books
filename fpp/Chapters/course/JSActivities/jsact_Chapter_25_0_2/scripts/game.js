...
game.StartGame = function(){
	...
	game.mainEleImg =[];
		...
		game.mainEleImg[game.mainEleImg.length] = ['electron',  	175,   235];//image_id, image_X_Position, image_Y_Position
...
game.__gameInitialize = function( director ){
	...
	//game.createBottomBox(75, 13,90);
	//game.createTopBox(104.6,75, 147.4);
...
game.createBottomBox=function(y){

game.bottomBox = new CAAT.Foundation.ActorContainer().					
					//setBounds( 0, 0, game.mainPanel.width, game.mainPanel.height ).
					setBounds(453, 250,310, 250).
					setClip(true);
...
game.drawGraphContainer = function() {	
	...
	game.drawingActor = new CAAT.Foundation.Actor().
						setBackgroundImage( canvas ).
							setBounds( 453, game.mainEleImg[0][2]+250,310, 250 );
