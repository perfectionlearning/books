...
;(function() {	
	...
	var dashBoardTxt = [];
		...
		dashBoardTxt[dashBoardTxt.length] = ['3.0   m/s', 		  'bold 14px arial',  	'left', 225, 32];
		dashBoardTxt[dashBoardTxt.length] = ['0.0   m/s', 		  'bold 14px arial',  	'left', 225, 57];
		dashBoardTxt[dashBoardTxt.length] = ['0.0', 		      'bold 14px arial',  	'left', 140, 32];//hareVelocity --> id = 6	
	...
	var bannerContentTxt = [];
		...
		bannerContentTxt[bannerContentTxt.length] = ["Great job!", 'You beat the tortoise!'];
