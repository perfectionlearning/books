...
game.StartGame = function(){
	...
	game.Values = [10.000,-3.000,0.000,0.000,0.000];
	game.mainEleTxt = [];
        game.mainEleTxt[game.mainEleTxt.length] = ['+10.000 '+String.fromCharCode(181)+'C', 'Bold 14px Arial', '#f00f00', 15, 240];
        game.mainEleTxt[game.mainEleTxt.length] = ['-3.000 '+String.fromCharCode(181)+'C', 'Bold 14px Arial',  '#000', 15, 290];
