...
;(function() {
	...
	var dashBoardTxt = [];					//Text, font_style, alignment, xPos, yPos, id, fontColor
		...
		dashBoardTxt[dashBoardTxt.length] = ['T', 		'bold 13px arial', 'left', 295, 38, 1, '#FFF'];
		...
		dashBoardTxt[dashBoardTxt.length] = ['0.700',	'bold 14px arial', 'left', 238, 37, 'incTxt', '#FFF'];//initial speed
