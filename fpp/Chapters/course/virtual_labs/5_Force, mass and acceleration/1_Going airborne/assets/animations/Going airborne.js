...
(lib.mc_01 = function(mode,startPosition,loop) {
	...
	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f().s("#B6B9B5").ss(0.5,1,1).p("AAVAAIAcAFIgBAEIgFAeAAVAAIgNgBIgXgFIgbgFIgCANQALgEASAAQALgBAMACAAQgiIALACIgGAgAAQgiIgGgBQgMgCgJAMIACgNIATADAgvAPIADgNAgPgGIABgJQAWgBAIgSAgLgZIgDAKAAtAIQguASgugLAgwAWIABgH");
