...
(lib.beachhouse = function(mode,startPosition,loop) {
	...
	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#9F9244").s().p("");
	...
	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#7D5B1C").s().p("");
...
(lib.tree_Iceland = function(mode,startPosition,loop) {
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#708A33").s().p("");
...
(lib.fdhf = function(mode,startPosition,loop) {
	...
	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.lf(["#28CEF5","#94FBFD"],[0,1],970.1,-29.7,969.9,26.8).s().p("AoTBKQjYgdADgtQADgrDaggQDageE2AAQE0AADWAeQDdAggDArQgCAtjhAdQjaAgkxAAQk4AAjWggg");
	this.shape_20.setTransform(575.9,603.6);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#ACF3EB").s().p("");
	this.shape_21.setTransform(397.9,576.3);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#FFFFFF").s().p("");
	this.shape_22.setTransform(390.5,515.8);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#FCE4C2").s().p("AouEGQAAgFABgEQAIgcBAgjQAbg+j6gVQvIgphZhYQgKgJAAgKQgBgJAJgKIACgCQAkgmCtgvQMri1LkgUIBrgBICFABQBCgBBCACIAJABQFRAWE9AqQE9ArEDCZQAfAIAZAIIAFACQA4ATAbAWQBhBOkEBiIg0AMQq7CetiAfQoLgIgFhQg");
	this.shape_23.setTransform(390.6,494.7);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.lf(["#28CEF5","#94FBFD"],[0,1],939.8,-67.9,939.2,71.5).s().p("");
	this.shape_24.setTransform(387.4,513.8);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.lf(["#28CEF5","#94FBFD"],[0,1],-2.9,-37.6,0.3,200.8).s().p("Ehgtgf2MDBbAAAMAAAA/qIt2AAMieyAADI0zAAg");
...
(lib.Symbol8 = function(mode,startPosition,loop) {
	...
	// Layer 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AT9EPIAAodIAgAAIAAIdgA0cEPIAAodIAfAAIAAIdg");
