...
var scope = this;
	...
	function play(){
		if(!this.init){
			...
			this.car1._initialize(c1.name,c1.maxAcceleration,c1.maxVelocity,c1.velocity,c1.finalVelocity,c1.velocityX,c1.displacementX,c1.displacementY,c1.angle,c1.track,c1.animation);
			this.car2._initialize(c2.name,c2.maxAcceleration,c2.maxVelocity,c2.velocity,c2.finalVelocity,c2.velocityX,c2.displacementX,c2.displacementY,c2.angle,c2.track,c2.animation);
			this.init=true;
...
var control=(function(){
	...
	function startConditions(){
		if(this.finalVelocity != 0){ 
			this.velocityX = 0;		
    		this.accelerationX = (0.5 * (this.finalVelocity * this.finalVelocity)/21.36);
			if(this.name=="redCar"){
					lab.layout.speedometer2.value = this.accelerationX;
			}
