...
var ChargeClass = (function(){
	...
	Class.prototype._update = function(_charges, count){
		if(this.started){
			...
			if((lab.layout.ball.x < 914 && lab.layout.ball.x > 892 && lab.layout.ball.y<603 && lab.layout.ball.y>578) && (this._velocity.magnitude()<0.2)){
				this._Hole(_charges);
			}
			else{
	...
	Class.prototype._click=function(){
		...
		window.location.href="../Hole 5_Electric golf − the practice green/index.html?"+a+"&"+b;
	}
