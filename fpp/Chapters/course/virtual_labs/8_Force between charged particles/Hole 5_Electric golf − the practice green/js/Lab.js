...
var	obstacleArray = []; 
var sandTrap = [{"left":740,"right":790,"top":585,"bottom":641},
...
var Lab = (function(){
	...
	Activity.prototype._createInstances = function(){
		var array = ["ball","putter","chargep36e","chargep-18e1","chargep-18e2"],
			object,
			scope = this;
...
var ChargeClass = (function(){
	...
	Class.prototype._update = function(_charges, count){
		if(this.started){
			...
			if((lab.layout.ball.x < 947 && lab.layout.ball.x > 922 && lab.layout.ball.y<383 && lab.layout.ball.y>359) && (this._velocity.magnitude()<0.2)){
				this._Hole(_charges);
			}
			else{
