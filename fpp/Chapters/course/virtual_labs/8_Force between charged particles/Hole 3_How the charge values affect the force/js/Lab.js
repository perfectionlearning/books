...
var	obstacleArray = [{"left":625,"right":645,"top":21,"bottom":361},
					 {"left":21,"right":386,"top":295,"bottom":317}];
var sandTrap = [{"left":386,"right":442,"top":230,"bottom":283},
...
var Lab = (function(){
	...
	Activity.prototype._createInstances = function(){
		var array = ["ball","putter","chargep20e1","chargep20e2","chargep-5e1","chargep-5e2"],
			object,
			scope = this;
...
var ChargeClass = (function(){
	...
	Class.prototype._update = function(_charges, count){
		if(this.started){
			...
			if((lab.layout.ball.x < 935 && lab.layout.ball.x > 903 && lab.layout.ball.y<562 && lab.layout.ball.y>528) && (this._velocity.magnitude()<0.2)){
				this._Hole(_charges);
			}
			else{
	...
	Class.prototype._obstacleBounce= function(){
			var temp;
			var xDist,yDist,xDir,yDir,pLR=0,pTB=0;
			// debugger;
	...
	Class.prototype._intersects = function(obs){
		if((this.x + lab._ballRadius)>obs.left && (this.x - lab._ballRadius)<obs.right && (this.y + lab._ballRadius)>obs.top && (this.y - lab._ballRadius)<obs.bottom){
			return true;
		}
		else{
			return false;
	...
	Class.prototype._click=function(){
		...
		window.location.href="../Hole 4_Extra credit − Determining Coulomb’s law/index.html?"+a+"&"+b;
	}
