		...
		for(var ll = 0; ll < 2; ll++){
			...
			this._points.forEach(function(v, i){
				...
				if(v.bird){
					...
					if(waveLength && v.bird._thresholdF && (v.y.toFixed(2) * 1 >= (this._A - 0.01) && this._A != 0) && (waveLength.toFixed(1)== 1 || waveLength.toFixed(2)==0.50 || waveLength.toFixed(2)==0.33 || waveLength.toFixed(2)==0.25 || waveLength.toFixed(3)==0.200||waveLength.toFixed(3)==0.167))
					{
						v.bird.flag1 = true;
						
						
					}
					if(waveLength && v.bird._thresholdF && this._A != 0 && (waveLength.toFixed(1)!= 1 && waveLength.toFixed(2)!=0.50 && waveLength.toFixed(2)!=0.33 && waveLength.toFixed(2)!=0.25 && waveLength.toFixed(3)!=0.200 && waveLength.toFixed(3)!=0.167))
					{
						v.bird.flag1 = false;
						this._cntFlew = 0;
					}
					if(this.layout["bird1"].flag1 && this.layout["bird2"].flag1 && this.layout["bird3"].flag1)
						{
