...
var Lab = (function(){
	...
	Activity.prototype.startLab = function(){
		...
		this.layout.timeStepper.addEventListener("valueChange", function(e){
			...
			if(scope._waveStart2>scope._points.length) scope._waveStart2 = scope._points.length-1;
	...
	function enterFrame(e,val){
		...
		if(this._thetaAtStart2>=Math.PI) { this._waveStart2-=3;   this._flag3=true; }
		else { this._flag3 = false; }
