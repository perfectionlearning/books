        ...
        var Toolbar = function ToolbarClosure() {
          ...
          Toolbar.prototype = {
            ...
            _bindListeners: function Toolbar_bindClickListeners() {
              ...
              var self = this;
              var items = this.items;
              document.addEventListener('pageChangeEvent', function (e) {
                eventBus.dispatch('setPage', e);
              });
      ...
      (function (root, factory) {
        ...
        var PDFViewerApplication = {
          ...
          bindEvents: function pdfViewBindEvents() {
            ...
            eventBus.on('setPage', function (e) {
              webViewerSetPage(e);
            });
          },
        ...
        function webViewerSetPage(e, data) {
          PDFViewerApplication.page = e.page;
        }
